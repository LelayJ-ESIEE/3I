...
namespace SpaceInvaders
{
    class Game
    {
        ...
        public void Update(double deltaT)
        {
            ...
            {
                // move every BalleQuiTombe on the left
                foreach(GameObject gameObject in gameObjects)
                {
                    if ((gameObject as BalleQuiTombe) != null)
                        ((BalleQuiTombe)gameObject).Move(this, deltaT, "l");
                }
            }
            ...
            if (keyPressed.Contains(Keys.Right))
            {
                ...
                {
                    if ((gameObject as BalleQuiTombe) != null)
                        ((BalleQuiTombe)gameObject).Move(this, deltaT, "r");
                }
            }
