...
public class CalculatriceStandardControleur extends AbstractControleur {
	private CalculatriceModele modele;
	
	@FXML private AnchorPane calculatriceStandardAnchorPane;
	...
	public CalculatriceStandardControleur(){
		super(Contr.STANDARD);
	}
	
	public AnchorPane getAnchorPane() {
		return calculatriceStandardAnchorPane;
	}
